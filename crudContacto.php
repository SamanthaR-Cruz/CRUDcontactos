...
if (isset($_SESSION["usuario"])) {
    if (isset($_POST["txtClave"]) && isset($_POST["txtOpe"])) {
        ...
        if ($bExito) {
            if ($sOpe == "a") {
                header("Location: contactosUsuario.php?agregado=1");
            } elseif ($sOpe == "m") {
                header("Location: contactosUsuario.php?modificado=1");
            } elseif ($sOpe == "b") {
                header("Location: contactosUsuario.php?eliminado=1");
            }
            exit();
...
<section>
    ...
    <form name="crudContacto" action="crudContacto.php" method="post">
        ...
        <input type="submit" value="Cancelar" onclick="crudContacto.action='muestraContactos.php';">
    </form>
</section>
